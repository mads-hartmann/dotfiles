# Improved interface to Git based on fzf.
#
# This adds a couple of nice key-bindings to Zsh that uses fzf to provide a
# nice interactive ui.
#
# This is completely stolen form the link below and then modified slightly
#
