;;; Basic Light --- A basic light theme.
;;

;;; basic-light-theme.el
;;; Commentary:
;;; Code:

(deftheme basic-light)
...
(let ((white "#FFF")
  ...
  (custom-theme-set-faces
   ...
   `(gui-element ((t (:background ,gray :foreground ,black))))
   ...
   `(mode-line ((t (:background ,gray :foreground ,black :box (:color ,dark-gray)))))
   `(mode-line-inactive ((t (:background ,white :foreground ,black :box (:color ,dark-gray)))))
   `(header-line ((t (:background ,white :foreground ,black :box nil))))
   ...
   `(font-lock-comment-face ((t (:foreground ,dark-gray :distant-foreground ,dark-gray))))
   ...
   ;; linum-mode
   `(linum ((t (:background ,white :distant-foreground ,black :foreground ,black :box nil))))
   ...
   ;; ;; dired
   `(dired-header ((t (:foreground ,black :background nil :weight bold :underline t))))
   `(dired-directory ((t (:foreground ,black :weight bold))))
   ...
   ;; ;; bookmark
   ;; `(bmkp-light-fringe-autonamed ((t :background ,base0F :foreground nil)))
   ;; `(bmkp-light-autonamed ((t :background ,base01)))
   ...
   ;; ;; helm
   `(helm-source-header ((t (:foreground ,black :weight bold))))
   `(helm-header ((t (:foreground ,black :background ,white :underline nil :slant italic))))
...
(provide-theme 'basic-light)

;;; basic-light-theme.el ends here
